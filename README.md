...
Na een carrière als (top)sportcoach en een academische achtergrond in Finance en Fysiologie,  
...
* **Machine Learning:** Scikit-learn, PyTorch, Random Forest, SHAP values (Explainability)
